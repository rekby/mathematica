...
Begin["`Private`"];
	...
	deduplicateFaces[list_List] := Module[{},
		Fold[
	...
	faceWithSamePlaceQ[a_ /; SimplePolygonQ[a], b_ /; SimplePolygonQ[b]] := polygonWithSamePlaceQ[a,b];
	faceWithSamePlaceQ[a_Association /; KeyExistsQ[a, "BoundingBox"], b_Association /; KeyExistsQ[b, "BoundingBox"]] := polygonWithSamePlaceQ[ a[["BoundingBox"]], b[["BoundingBox"]] ];
	
	polygonWithSamePlaceQ[p1_, p2_] := Min[Area[p1], Area[p2]] * 0.5 < Area[RegionIntersection[p1, p2]];

	faceBetter[a_ /; SimplePolygonQ[a], b_ /; SimplePolygonQ[b]] := MinimalBy[{a, b}, Area][[1]];
	faceBetter[a_Association /; KeyExistsQ[a, "Strength"], b_Association /; KeyExistsQ[b, "Strength"]] := MaximalBy[{a,b}, #[["Strength"]] & ][[1]];
	faceBetter[a_Association /; KeyExistsQ[a, "BoundingBox"], b_Association /; KeyExistsQ[b, "BoundingBox"]] := MinimalBy[{a,b}, Area[ #[["BoundingBox"]] ] & ][[1]];
